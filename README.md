...
and called for someone to fork it. This repository is that fork — started by
[OpusProjects](https://github.com/OpusProjects) in June 2026 to carry the project
forward, picking up [@nuxsmin](https://github.com/nuxsmin)'s own planned
[hexagonal-architecture rework](https://github.com/nuxsmin/sysPass/tree/feat/code_refactoring)
as the new baseline. All original copyright and the GNU GPLv3 license are retained.
