...
namespace SP\Tests\Infrastructure\Adapter\Out\Account\Repositories;
...
use SP\Infrastructure\Adapter\Out\Account\Repositories\AccountHistory;
        ...
        $callback = new Callback(
            static function (QueryData $arg) use ($id) {
                return $arg->getQuery()->getBindValues()['id'] === $id
                       && $arg->getMapClassName() === AccountHistoryView::class
