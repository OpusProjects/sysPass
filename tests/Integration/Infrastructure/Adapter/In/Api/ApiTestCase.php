...
abstract class ApiTestCase extends TestCase
{
    ...
    private const REST_ROUTES = [
        ...
        AclActionsInterface::NOTIFICATION_SEARCH => ['GET', '/api/v1/notifications'],
        AclActionsInterface::NOTIFICATION_CREATE => ['POST', '/api/v1/notifications'],
        AclActionsInterface::NOTIFICATION_VIEW   => ['GET', '/api/v1/notifications/{id}'],
        AclActionsInterface::NOTIFICATION_EDIT   => ['PUT', '/api/v1/notifications/{id}'],
        AclActionsInterface::NOTIFICATION_DELETE => ['DELETE', '/api/v1/notifications/{id}'],
        AclActionsInterface::NOTIFICATION_CHECK  => ['PUT', '/api/v1/notifications/{id}/check'],
