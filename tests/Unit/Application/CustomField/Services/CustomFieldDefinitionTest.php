...
namespace SP\Tests\Unit\Application\CustomField\Services;
...
class CustomFieldDefinitionTest extends UnitaryTestCase
{
     ...
     * definitions while a colleague deleted one of them was told the whole selection had been
     * removed. Nine of the thirteen services already compare the count against the ids they were
     * given; these four did not. Here the refusal happens inside the transaction, so it takes the
     * partial delete with it.
     *
     * @throws ServiceException
     * @throws SPException
     */
