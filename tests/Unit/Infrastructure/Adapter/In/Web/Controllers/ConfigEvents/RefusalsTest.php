...
namespace SP\Tests\Unit\Infrastructure\Adapter\In\Web\Controllers\ConfigEvents;
...
use SP\Infrastructure\Adapter\In\Web\Controllers\ConfigEvents\SaveController;
 ...
 *
 * `ConfigEvents` has a single controller, and it — like every other controller in the `Config*`
...
class RefusalsTest extends WebControllerTestCase
{
    ...
    public function savingIsRefusedWhenTheAclDenies(): void
    {
        ...
        new SaveController(
            $application,
            $this->simpleControllerHelper($acl, 'configEvents', 'save')
        );
    }
