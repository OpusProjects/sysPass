...
namespace SP\Infrastructure\Context {
    ...
    /**
     * Shadows the global headers_sent() for code running in the SP\Infrastructure\Context
...
namespace SP\Tests\Unit\Infrastructure\Context {
    ...
    use SP\Infrastructure\Context\HeadersSentState;
    ...
    public function testStartWithHeadersSent()
    {
        ...
        // (see the SP\Infrastructure\Context block at the top of this file) and force it to report
