...
final class ConfigUtil
{
    ...
    public static function checkConfigDir(): void
    {
        ...
        if (!is_dir($configPath)) {
            ...
            throw new ConfigException(__u('\'/config\' directory does not exist.'), SPException::CRITICAL);
        }

        if (!is_writable($configPath)) {
            clearstatcache();

            throw new ConfigException(__u('Unable to write into \'/config\' directory'), SPException::CRITICAL);
        }
