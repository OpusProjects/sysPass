...
define('MODULES_PATH', FileSystem::buildPath(APP_ROOT, 'src', 'Infrastructure', 'Adapter', 'In'));
...
function initModule(string $module): array
{
    ...
    try {
        $definitions = FileSystem::require(FileSystem::buildPath(MODULES_PATH, ucfirst($module), 'module.php'));
