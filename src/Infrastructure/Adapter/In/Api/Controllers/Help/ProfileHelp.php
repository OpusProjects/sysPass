...
/**
 * The parameters the profile endpoints take, which is what a caller is shown when one is
 * missing.
 */
final class ProfileHelp implements HelpInterface
{
    use HelpTrait;
    ...
    {
        return [
            self::getItem('id', __('Profile Id'), true)
        ];
    }
    ...
    {
        return [
            self::getItem('name', __('Profile name'), true),
            self::getItem('profile', __('Profile permissions'), true)
        ];
    }
