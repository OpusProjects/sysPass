...
final class UserForm extends FormBase implements FormInterface
{
    ...
    protected function analyzeRequestData(): void
    {
        ...
        $this->userData = new User([
            ...
            'isAdminApp' => $this->context->getUserData()->isAdminApp && $this->request->analyzeBool('adminapp_enabled', false),
            'isAdminAcc' => $this->context->getUserData()->isAdminApp && $this->request->analyzeBool('adminacc_enabled', false),
    ...
    protected function checkDelete(): void
    {
        ...
        if ($this->itemId === $userData->id
            || (is_array($this->itemId)
                && in_array($userData->id, $this->itemId, true))
        ) {
