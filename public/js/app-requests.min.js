...
url:g(a.url),method:a.method,async:a.async,data:a.data,cache:a.cache,processData:a.processData,contentType:a.contentType,timeout:a.timeout,headers:d,beforeSend:function(){!0===a.useLoading&&c.theme.loading.show(a.useFullLoading)},success:function(c){if("function"!==typeof b)return!0;c&&"object"===typeof c&&"string"===typeof c.status&&(c.status={OK:0,ERROR:1,WARNING:2}[c.status]??c.status);!0===a.addHistory&&(a.callback=b,l.add(a));b(c)},error:function(b,f,d){"function"!==typeof m?(f=void 0!==c.config.LANG[1]?c.config.LANG[1]:"An error occurred",f+="<p>"+d+"</p><p>"+b.responseText+"</p>",e.error(f),"html"===
a.type&&$("#content").html(c.msg.html.error(f)),c.msg.error(f)):m()},complete:function(b){!0===a.useLoading&&c.theme.loading.hide();void 0!==c.theme&&("html"===a.type||void 0!==b.responseJSON&&null!=b.responseJSON.data&&void 0!==b.responseJSON.data.html)&&c.theme.ajax.complete()}})},getActionEvent:function(a,b,c){var d=new EventSource(g(a.url));d.addEventListener("message",function(a){a=JSON.parse(a.data);e.debug(a);1===a.end?(e.info("getActionEvent:Ending"),d.close(),"function"===typeof c&&c(a)):
